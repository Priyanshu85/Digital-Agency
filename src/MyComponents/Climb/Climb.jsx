    ...
    return (
        <div className='mt-3 md:flex'>
            <div className='flex flex-col items-center md:items-start'>
                ...
                <p className="text-gray-600 font-extrabold font-sans text-6xl flex text-center w-40 -ml-32 md:text-left md:ml-44 md:w-3/4 md:mt-7">We bring you new customers</p>
                <p className='text-gray-400 font-semibold text-sm flex text-center justify-center mt-5 w-44 md:w-3/5 md:text-xl md:text-left md:ml-44'>We build effectivestrategies to help you reach customers and prospects across the entire web</p>
