...
<footer className="p-4 bg-[#8A02F2] sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
        <a href="/" className="items-center flex">
                <img src={logoWhite} className="mr-3 h-8" alt="logo"/>
            </a>
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul className="text-white">
                    <li className="mb-4">
                        <a href="https://github.com/Priyanshu85" className="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-white sm:text-center">© 2022 <a href="/" className="hover:underline">Digital Agency™</a>. All Rights Reserved.
        </span>
