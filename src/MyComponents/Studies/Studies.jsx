...
function Studies() {
    return (
        <div className='bg-gray-100 mt-10 flex flex-col items-center'>
            <div className='lg:ml-[16rem] lg:w-full'>
            ...
            <div className='md:flex cursor-pointer justify-evenly -mt-12 lg:mt-[1.5rem] md:mt-2'>
            <div className="w-80 bg-[#ffffff] lg:w-[18rem] md:w-96 md:h-3/5 rounded-3xl overflow-hidden  md:mt-0 shadow-xl md:mr-10 mt-14 hover:shadow-2xl bg-scroll mb-20">
            ...
            <div className="hidden md:block w-80 bg-[#ffffff] lg:w-[18rem] md:w-96 md:h-3/5 rounded-3xl overflow-hidden  md:mt-0 shadow-xl md:mr-10 mt-14 hover:shadow-2xl bg-scroll mb-20">
                <img className="w-full"
                    src={tremely}
                    alt="tremely"/>
                <div className="px-9 py-12">
